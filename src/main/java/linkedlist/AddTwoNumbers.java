 ...
 * @description: 两数相加
 * @author: xuefei
 * @date: 2022/03/06 23:32
 */
public class AddTwoNumbers {
    public static void main(String[] args) {
        Node headNode1 = LinkedListCreator.createLinkedList(Arrays.asList(1, 2, 0, 5, 4));
        Node headNode2 = LinkedListCreator.createLinkedList(Arrays.asList(3, 2, 4, 1, 6));

        Node node = addTwoNumbers(headNode1, headNode2);
        LinkedListCreator.printList(node);
